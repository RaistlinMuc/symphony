defmodule SymphonyElixir.Tracker.GitLab.Adapter do
  @moduledoc """
  GitLab adapter wrapper for project-scoped tracker operations.
  """

  alias SymphonyElixir.Project
  alias SymphonyElixir.Tracker.GitLab.Client
